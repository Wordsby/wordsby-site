...
| [statement](src/patterns/statement/SKILL.md) | 1.0.0 | One large italic statement beside an optional heading and a few short paragraphs. Use to land a single idea, like the problem a client solves, before explaining it. |
